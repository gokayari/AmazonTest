 ...
 */
   ...
   /* public static void switchWindowAndVeriy(String expectedInUrl, String expectedInTitle) {
    ...
    */
    ...
    //we get all the radio buttons in a list and click the related one.
    public static void clickRadioButton(List<WebElement> radioButtons, String expectedAttributeValue){

        for (WebElement each : radioButtons) {
            if(each.getAttribute("value").equalsIgnoreCase(expectedAttributeValue)){
                each.click();
            }
        }
